...
export const PERKS: PerkSpec[] = [
  ...
  { id: 'charmer', tree: 'sales', name: 'Charmer', blurb: 'Small talk never falls flat. Charm tips +50%, rapport grows twice as fast.' },
  { id: 'straight_lines', tree: 'craft', name: 'Straight Lines', blurb: 'Auto stripes: every pass lays clean alternating bands, no striping kit needed.' },
