...
export const HOODS: HoodSpec[] = [
  {
    id: 'maple', name: 'Maple Grove', kind: 'residential', lawnM2: [260, 420], wealth: [0.85, 1.1], houses: 28, km: 0.5,
  ...
  {
    id: 'oak', name: 'Oak Hills', kind: 'residential', lawnM2: [480, 900], wealth: [1.0, 1.25], houses: 30, km: 3,
  ...
  {
    id: 'willow', name: 'Willow Creek Estates', kind: 'estate', lawnM2: [1400, 3000], wealth: [1.3, 1.8], houses: 20, km: 7,
  ...
  {
    id: 'heritage', name: 'Heritage Hills', kind: 'estate', lawnM2: [2500, 5000], wealth: [1.8, 2.6], houses: 14, km: 12,
    baseLeads: 0.35, unlock: { rep: 4.4, rideOn: true }, styles: ['mansion', 'modern'], answerRate: 0.4,
    blurb: 'Gated estates. Stripes are not optional.',
  },
  {
    id: 'pinecrest', name: 'Pinecrest Business Park', kind: 'commercial', lawnM2: [3000, 6000], wealth: [1, 1], houses: 10, km: 9,
    baseLeads: 0, unlock: { rep: 4.1, insurance: true, crews: 1 }, styles: ['office', 'church', 'school'], answerRate: 0,
    blurb: 'Office lawns on contract. Won by bid.', bidOnly: true,
  },
  {
    id: 'parks', name: 'Civic Parks and Fields', kind: 'park', lawnM2: [8000, 15000], wealth: [1, 1], houses: 6, km: 6,
    baseLeads: 0, unlock: { rep: 4.3, wideArea: true }, styles: ['pavilion'], answerRate: 0,
  ...
  },
  {
    ...
    baseLeads: 0, unlock: { rep: 4.6, gang: true }, styles: ['clubhouse'], answerRate: 0,
