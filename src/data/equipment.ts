...
export const EQUIPMENT: EquipmentSpec[] = [
  ...
  {
    id: 'push21', name: 'Gas Push Mower 21"', category: 'mower', tier: 1, price: 180,
  ...
  {
    id: 'selfprop', name: 'Self-Propelled 22" with Bagger', category: 'mower', tier: 2, price: 420,
  ...
  {
    id: 'walkbehind', name: 'Commercial Walk-Behind 36"', category: 'mower', tier: 3, price: 1900,
  ...
  {
    id: 'zt48', name: 'Zero-Turn 48"', category: 'mower', tier: 4, price: 4600,
  ...
  {
    id: 'standon', name: 'Stand-On 52"', category: 'mower', tier: 5, price: 7400,
  ...
  {
    id: 'zt60', name: 'Pro Zero-Turn 60"', category: 'mower', tier: 5, price: 8800,
  ...
  {
    id: 'trimmer', name: 'String Trimmer', category: 'trimmer', tier: 1, price: 90,
  ...
  {
    id: 'protrimmer', name: 'Pro Trimmer and Edger', category: 'trimmer', tier: 3, price: 320,
  ...
  {
    id: 'blower', name: 'Handheld Blower', category: 'blower', tier: 1, price: 80,
  ...
  {
    id: 'backpack', name: 'Backpack Blower', category: 'blower', tier: 3, price: 340,
  ...
  {
    id: 'pickup', name: 'Used Pickup', category: 'vehicle', tier: 2, price: 3900,
  ...
  {
    id: 'pickup_trailer', name: 'Pickup and 12 ft Trailer', category: 'vehicle', tier: 3, price: 6900,
  ...
  {
    id: 'crewtruck', name: 'Crew Cab Truck and 16 ft Trailer', category: 'vehicle', tier: 5, price: 24000,
  ...
  {
    id: 'boxtruck', name: 'Box Truck', category: 'vehicle', tier: 6, price: 42000,
  ...
  {
    id: 'stripekit', name: 'Striping Roller Kit', category: 'addon', tier: 2, price: 220,
    blurb: 'Auto stripes: the roller lays clean bands wherever you mow. Bigger stripe bonus.',
    model: 'addon_stripekit', thumb: 'addon_stripekit',
  },
  {
    id: 'sharpener', name: 'Blade Sharpening Station', category: 'addon', tier: 2, price: 350,
    blurb: 'Blades sharpened overnight for free.',
    model: 'addon_sharpener', thumb: 'addon_sharpener',
  },
  {
    id: 'bagger', name: 'Bagging Attachment', category: 'addon', tier: 1, price: 120,
